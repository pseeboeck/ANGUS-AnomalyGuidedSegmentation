...
This repository contains the anomaly maps for the RETOUCH-dataset created by [WeakAND](https://ieeexplore.ieee.org/abstract/document/8727461)[^1] which were used as training targets for the ANGUS approach.

[^1]: Seeböck, Philipp, et al. "Exploiting epistemic uncertainty of anatomy segmentation for anomaly detection in retinal OCT." IEEE transactions on medical imaging 39.1 (2019): 87-98.
